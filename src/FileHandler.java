...
public class FileHandler {
    ...
    public static void appendRecord(String data,int rowwidth) {
        String filename = "C:\\\\Users\\\\Matthew\\\\Documents\\\\File02.txt";
    ...
    public String getRecord(int rowNumber) {
        return FileHandler.readLineAt(filename, (rowNumber-1)*(rowWidth+2));
    }
    ...
    public boolean findRecord(String SearchData) {
        ...
        for(int i = 1; i-1<countLines(filename);i++){
            if(Objects.equals(SearchData,getRecord(i))){
                ...
                System.out.println("Compared " + SearchData + " to " + getRecord(i) + ", negative");
            }
